...
if __name__ == '__main__':
    ...
    with tf.Graph().as_default():
        ...
        with tf.Session() as sess:
            ...
            while step < maxsteps:
                ...
                if step % 1000 == 0:
                    saver.save(sess, './save', global_step=step*batch_size)
                    step += 1
    ...
    while step_test * batch_size < len(validation):
        ...
        print "Testing label:", validation.label2category[np.argmax(testing_ys, 1)[0]]
        print "Testing predict:", validation.label2category[np.argmax(predict, 1)[0]]
    step_test += 1
