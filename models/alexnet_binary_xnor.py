    ...
    def conv_layers(self, batch_norm, phase):
        ...
        if self.binary:
            ...
            with tf.name_scope('conv2_bin') as scope:
                ...
                h_conv2 = self.conv2d(tf.nn.relu(h_pool1_bin), Wb_conv2, s=1)
            ...
            with tf.name_scope('conv5_bin') as scope:
                ...
                h_pool5_bin = self.binary_tanh_unit(h_pool5)
            ...
            with tf.name_scope('fc6_bin') as scope:
                ...
                h_fc6_bin = self.binary_tanh_unit(h_fc6_d)
            ...
            with tf.name_scope('fc7_bin') as scope:
                ...
                #h_fc7_bin = self.binary_tanh_unit(h_fc7_d)
